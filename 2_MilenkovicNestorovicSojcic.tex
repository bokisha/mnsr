...
\hline
Name & Jenkins & Buildbot \\ \hline
Platform & Servlet Containert & Python\\ \hline
License & Creative Commons and MIT & GPL(GNU General Public License)\\ \hline
Windows builders & MSBuild, NAnt & Yes(command line) \\ \hline
Java builders & Ant, Maven, Kundo & Yes(command line) \\ \hline
Other builders & Cmake, Gant, Gradle, Ruby, Python, Shell script and others & Yes(command line)\\ \hline
Notification & Android, E-mail, Google Calendar, IRC, XMPP, RSS, Slack & E-mail, Web, GUI, IRC \\ \hline
IDE Integration & Eclipse, Intellij IDEA, NetBeans & Unknown \\ \hline
Other Integration & Bugzilla, Google Code, JIRA and others & Unknown \\ \hline
\end{tabular}
\end{center} 
