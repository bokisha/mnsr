...
\begin{frame}[fragile]{Pokrivenost k\^oda}
    \begin{itemize}
        \item Metrika koja se ceni u testiranju softvera
        \item Ne daje značajnu informaciju o kvalitetu napisanog k\^oda već koliki deo k\^oda je pokriven testovima jedinica
        \item Cobertura za Javu
        \item Neki alati za \emph{x}Unit testove imaju ugrađene sisteme za pokrivenost k\^oda 
        \begin{itemize}
